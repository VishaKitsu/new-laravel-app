...
function TestButton({ children, color = "blue", ...props }: MyButtonProps) {
...
// function MyButton({ children, color = "blue", ...props }: { children: ReactNode; color: string } & React.ComponentProps<"button">) {
//   if (color == "blue"){
//     return (
//       <button 
...
//     return (
//       <button 
//         className="rounded-md bg-linear-to-b from-green-300 to-green-400 to-70% px-4 py-2 text-sm font-semibold text-green-950 shadow-md ring inset-shadow-2xs ring-green-500 inset-shadow-white/20 transition text-shadow-2xs text-shadow-green-300 hover:from-green-300/80 dark:ring-green-500/50"
//         {...props}
//       >
//         {children}
//       </button>
...
//     return (
//       <button 
//         className="rounded-md bg-linear-to-b from-red-300 to-red-400 to-70% px-4 py-2 text-sm font-semibold text-red-950 shadow-md ring inset-shadow-2xs ring-red-500 inset-shadow-white/20 transition text-shadow-2xs text-shadow-red-300 hover:from-red-300/80 dark:ring-red-500/50"
//         {...props}
//       >
//         {children}
//       </button>
...
//     return (
//       <button 
//         className="rounded-md bg-secondary bg-linear-to-b from-white/10 to-white/20 to-70% px-4 py-2 text-sm font-semibold text-gray-950 shadow-md ring inset-shadow-2xs ring-black/20 inset-shadow-white/10 transition hover:from-white hover:to-white/10 dark:text-white dark:text-shadow-2xs"
//         {...props}
//       >
//         {children}
//       </button>
